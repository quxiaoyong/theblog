...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`theblog_picture` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
DROP TABLE IF EXISTS `t_file_catalog`;

CREATE TABLE `t_file_catalog` (
  `uid` varchar(36) NOT NULL COMMENT '唯一uid',
...
insert  into `t_file_catalog`(`uid`,`project_name`,`sort_name`,`url`,`status`,`create_time`,`update_time`) values ('a9a747d944c24845815356f72723ef8e','blog','admin','/blog/admin',1,'2018-09-20 14:41:57','2018-09-20 19:40:02'),('a9a747d944c24845815356f72723ef8f','blog','web','/blog/web',1,'2018-09-20 19:40:37','2018-09-20 19:40:40');
