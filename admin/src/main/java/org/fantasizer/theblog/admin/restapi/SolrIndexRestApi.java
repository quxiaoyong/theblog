...
public class SolrIndexRestApi {
    ...
    public String searchBlog(HttpServletRequest request,
        ...
        if (StringUtils.isNotEmpty(keywords) && StringUtils.isEmpty(keywords.trim())) {
            return ResultUtil.result(SystemConfiguration.SUCCESS, "内容不能为空");
        }
    ...
    public String initIndex(HttpServletRequest request) {
        ...
        queryWrapper.eq(BasicSystemConfiguration.STATUS, Status.ENABLED);
        ...
        log.info("初始化索引成功");
        return ResultUtil.result(SystemConfiguration.SUCCESS, "初始化索引成功");
    ...
    public String addIndex(HttpServletRequest request, @RequestBody Blog blog) {
        ...
        log.info("新建solr索引");
        return ResultUtil.result(SystemConfiguration.SUCCESS, "新建solr索引成功");
    }
    ...
    public String updateIndex(HttpServletRequest request, @RequestBody Blog blog) {
        ...
        log.info("更新solr索引");
        return ResultUtil.result(SystemConfiguration.SUCCESS, "更新solr索引成功");
    ...
    public String deleteIndex(HttpServletRequest request,
        ...
        log.info("删除部分索引");
        return ResultUtil.result(SystemConfiguration.SUCCESS, "删除索引成功");
    ...
    public String deleteAllIndex(HttpServletRequest request) {
        ...
        log.info("删除所有索引");
        return ResultUtil.result(SystemConfiguration.SUCCESS, "删除所有索引成功");
    }
}